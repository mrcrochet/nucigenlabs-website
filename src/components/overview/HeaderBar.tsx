      ...
      <div className="flex-1 max-w-md ml-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-1.5 bg-background-glass-subtle border border-borders-subtle rounded-lg text-text-primary placeholder-text-tertiary focus:outline-none focus:border-borders-medium focus:bg-background-glass-medium text-sm"
          />
        </div>
      </div>
    </div>
