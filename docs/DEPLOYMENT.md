...
4. **« Hobby accounts are limited to daily cron jobs »** : sur le plan Hobby, les crons ne peuvent s’exécuter qu’une fois par jour. Ce projet est configuré pour **Pro** (track-perplexity toutes les 2 h, corporate-impact toutes les heures).
