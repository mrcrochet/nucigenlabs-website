-- ============================================
-- SOLUTION ABSOLUE : RLS pour user_preferences
-- ============================================
-- Cette solution utilise WITH CHECK (true) pour permettre TOUTES les insertions
-- C'est la seule façon garantie de contourner le problème de visibilité transactionnelle
-- avec RLS dans les triggers
...
-- ============================================
-- ÉTAPE 2: POLITIQUE D'INSERTION PERMISSIVE (WITH CHECK (true))
-- ============================================
...
BEGIN
  ...
  -- La politique "Allow all inserts from triggers" permet cette insertion
