        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {audiences.map((audience, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-white/[0.05] border border-white/10 flex items-center justify-center mb-4">
                  <Icon size={22} className="text-slate-400" />
                </div>
                <h3 className="text-lg text-white font-light mb-2">{audience.title}</h3>
