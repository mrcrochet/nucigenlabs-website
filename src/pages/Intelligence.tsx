...
export default function Intelligence() {
  return (
    <main className="min-h-screen">
      ...
      />
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-32">
        <div className="max-w-5xl mx-auto w-full">
          <div className="text-center mb-20 sm:mb-40 animate-in fade-in duration-700">
            ...
            <p className="text-xs sm:text-sm text-slate-500 font-light mb-10 sm:mb-14 tracking-wide min-h-[2rem] px-4">
              <TypewriterText
                texts={[
          ...
          <div className="mb-20 sm:mb-40">
            <div className="text-center mb-12 sm:mb-24">
              <div className="inline-block mb-4 sm:mb-6 px-3 sm:px-4 py-1 rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-sm">
                <span className="text-[9px] sm:text-[10px] text-slate-600 font-light tracking-[0.25em]">CORE SYSTEM</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extralight mb-6 sm:mb-8 text-white tracking-tight px-4">
                The Intelligence Engine
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-slate-400 font-light leading-[1.9] max-w-2xl mx-auto px-4">
                Most systems watch price. Nucigen Labs watches the sequence of events that eventually forces price to move.
              </p>
            </div>

            <div className="space-y-6 sm:space-y-8">
              <div className="group backdrop-blur-xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.08] hover:border-white/[0.15] rounded-xl sm:rounded-2xl p-6 sm:p-12 transition-all duration-500 hover:shadow-2xl hover:shadow-white/[0.03] hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <div className="w-1.5 h-1.5 rounded-full bg-slate-500"></div>
                  <h3 className="text-xl sm:text-2xl text-slate-100 font-light tracking-wide">
                    Geopolitical Vector
                  </h3>
                </div>
                <p className="text-xs sm:text-sm text-slate-400 font-light leading-[2] mb-6 sm:mb-8">
              ...
              <div className="group backdrop-blur-xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.08] hover:border-white/[0.15] rounded-xl sm:rounded-2xl p-6 sm:p-12 transition-all duration-500 hover:shadow-2xl hover:shadow-white/[0.03] hover:-translate-y-1">
                ...
                <p className="text-xs sm:text-sm text-slate-400 font-light leading-[2] mb-4 sm:mb-6">
          ...
          <div className="mb-20 sm:mb-40">
            <div className="text-center mb-12 sm:mb-20">
              <div className="inline-block mb-4 sm:mb-6 px-3 sm:px-4 py-1 rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-sm">
                <span className="text-[9px] sm:text-[10px] text-slate-600 font-light tracking-[0.25em]">CASE STUDIES</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extralight mb-4 text-white tracking-tight px-4">
                Example Scenarios
              </h2>
            </div>

            <div className="space-y-4 sm:space-y-6">
              <div className="group border-l-2 border-white/[0.1] hover:border-white/[0.3] pl-6 sm:pl-10 py-4 sm:py-6 transition-all duration-300">
                <h3 className="text-lg sm:text-xl text-slate-200 font-light mb-3 sm:mb-5 tracking-wide group-hover:text-white transition-colors">
                  Lithium Treaty
                </h3>
          ...
          <div className="mb-20 sm:mb-32">
            <div className="relative backdrop-blur-xl bg-gradient-to-br from-white/[0.06] to-white/[0.02] border border-white/[0.12] rounded-xl sm:rounded-2xl p-8 sm:p-16 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-extralight mb-6 sm:mb-8 text-white tracking-tight leading-[1.3] px-4">
                  LLMs don't forecast.<br />They extract causal structure.
                </h2>
                <p className="text-xs sm:text-sm md:text-base text-slate-400 font-light leading-[2] max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
