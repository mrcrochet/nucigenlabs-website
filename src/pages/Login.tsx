...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex">
      <SEO 
        title="Login — Nucigen Labs"
        description="Sign in to your Nucigen Labs account"
      />
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="backdrop-blur-xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/[0.15] rounded-2xl p-8 shadow-xl">
            ...
            <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-white/20">
              <div className="w-8 h-8 bg-[#E1463E]/20 rounded-full flex items-center justify-center">
                <div className="w-4 h-4 bg-[#E1463E] rounded-full"></div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-[#E1463E] border-white/20 rounded focus:ring-[#E1463E] bg-white/5"
                  />
                  <span className="ml-2 text-sm text-slate-400">Keep me logged in</span>
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-[#E1463E] hover:text-[#E1463E]/80 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
